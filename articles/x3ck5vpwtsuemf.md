...
published: false
x_viral_post: "AIにコード書かせて「なんか違う…」ってなる人、全員これ導入して。 \n\nTSの神 Matt Pocockが、自分のClaudeで使ってる秘蔵スキル集『skills』を公開。 \n\n・AIが自分を問い詰めて仕様を固める /grill-me\n・プロジェクトの専門用語を1秒で理解させる Shared Language\n・GitHub/Linearと爆速連携 \n\n「バイブスでコードを書く」のはもう終わり。本物のエンジニアリングをAIに。 \n\n正直、これ知ってるだけで開発効率バグります。 \n\n詳細はブログで👇"
note_intro: "TypeScript界の伝説、Matt Pocock氏が公開したAIエージェント用スキル集『skills』。なぜこれほどまでにエンジニアの間で話題なのか？「Vibe Coding（なんとなくのコーディング）」を脱却し、AIを真のエンジニアに変えるための具体的な手法を徹底解説します。"
